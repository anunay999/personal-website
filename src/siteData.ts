...
export const siteData: SiteData = {
  profile: {
    ...
    title: "AI-native GTM engine · Data platform",
    location: "building from anywhere",
    status: "open to collaborate",
    bioPrefix: "Building at ",
    bioSuffix: " — data systems on the core platform powering an AI-native GTM engine.",
    bioText:
      "Building at Orbital — data systems on the core platform powering an AI-native GTM engine.",
